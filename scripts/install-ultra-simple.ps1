# Script de Instalación Ultra Simple del Sistema Automático de Git
Write-Host "=== INSTALACIÓN ULTRA SIMPLE DEL SISTEMA AUTOMÁTICO DE GIT ===" -ForegroundColor Cyan
