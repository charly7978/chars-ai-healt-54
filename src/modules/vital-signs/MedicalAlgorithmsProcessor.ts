...
export interface MedicalAlgorithmsConfig {
  enableCHROM: boolean;
...
export interface MedicalAlgorithmsResult {
...
export class MedicalAlgorithmsProcessor {
  private config: MedicalAlgorithmsConfig;
  ...
  private resultHistory: MedicalAlgorithmsResult[] = [];
  
  // Parámetros médicamente validados
  private readonly DEFAULT_CONFIG: MedicalAlgorithmsConfig = {
    enableCHROM: true,
    enableFastICA: true,
    enableEulerian: true,
  ...
  constructor(config: Partial<MedicalAlgorithmsConfig> = {}) {
   ...
   */
  private applyAdvancedProcessing(): MedicalAlgorithmsResult {
  ...
  private calculateFinalMetrics(
    ...
    const result: MedicalAlgorithmsResult = {
  ...
  private createInitialResult(): MedicalAlgorithmsResult {
    return {
      heartRate: 0,
      spo2: 98,
  ...
  private updateResultHistory(result: MedicalAlgorithmsResult): void {
   ...
   */
  public getResultHistory(): MedicalAlgorithmsResult[] {
   ...
   */
  public updateConfig(newConfig: Partial<MedicalAlgorithmsConfig>): void {
